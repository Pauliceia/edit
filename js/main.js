$(function() {
                ...
                form.find('.form_load').fadeOut('slow', function () {
                    ...
                    if (data.draw){
                        if(data.draw=='insert'){                           
                            ...
                            editFeatDuplic(data.drawIdAnt, data.drawId, data.idAuthor, "duplicData");
                        }
                    }
   ...
   $('.j_delete_action').click(function () {
    ...
    $('.j_delete_action_confirm').click(function () {
        ...
        $.post('ajax/' + CallbackMap + '.ajax.php', {callback: CallbackMap, callback_action: Callback_actionMap, del_id: DelIdMap}, function (data) {
            if (data.trigger) {
