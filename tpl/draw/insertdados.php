<article class="boxToobar form_draw" id="insertData"> 
    ...
    <div class="content">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" placeholder="name " id="clearForm">
        </div>
        <div class="form-group">
            <label for="street">&#10143; Street:</label>
            <input type="hidden" name="id_street" value="1">
            <input type="text" name="street" class="form-control" disabled>
        </div>
        <div class="form-group">
            <label for="number">&#10143; * Number:</label>
            <input type="number" name="number" class="form-control" required id="clearForm">
        </div>
        <div class="form-group">
            <label for="original_number">&#10143; Original Number:</label>
            <input type="text" name="original_number" class="form-control" placeholder="full number" id="clearForm">
        </div>
        <div class="form-group">
            <label>&#10143; First date (dd/mm/yyyy):</label>
            <br>
            <div class="col-lg-4">
                <input type="number" name="first_day" class="form-control" min="1" max="31" placeholder="day" id="clearForm">
            </div>
            <div class="col-lg-4">
                <input type="number" name="first_month" class="form-control" min="1" max="12" placeholder="month" id="clearForm">
            </div>
            <div class="col-lg-4">
        ...
        <div class="form-group">
            ...
            <br>
            <div class="col-lg-4">
                <input type="number" name="last_day" class="form-control" min="1" max="31" placeholder="day" id="clearForm">
            </div>
            <div class="col-lg-4">
                <input type="number" name="last_month" class="form-control" min="1" max="12" placeholder="month" id="clearForm">
            </div>
            <div class="col-lg-4">
                <input type="number" name="last_year" class="form-control" min="1868" max="1940" placeholder="year" id="clearForm">
            </div>
            <div class="clear"></div>
        </div>
        <div class="form-group">
            <label for="source">&#10143; * Source:</label>
            <input type="text" name="source" class="form-control" placeholder="fonte" required id="clearForm">
        </div>
